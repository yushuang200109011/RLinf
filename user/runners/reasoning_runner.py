...
from user.data.io_struct import RolloutRequest
from user.scheduler import Channel
from user.scheduler import WorkerGroupFuncResult as Handle
from user.utils.data_iter_utils import split_list
from user.utils.distributed import ScopedTimer
from user.utils.metric_logger import MetricLogger
from user.utils.runner_utils import check_progress, local_mkdir_safe
from user.utils.timers import Timer

if typing.TYPE_CHECKING:
    from user.scheduler.dynamic_scheduler.scheduler_worker import SchedulerWorker
    ...
    from user.workers.actor.megatron_actor_worker import MegatronActor
    from user.workers.inference.fsdp_inference_worker import FSDPInference
    from user.workers.inference.megatron_inference_worker import MegatronInference
...
class ReasoningRunner:
    ...
    def _build_dataloader(self, train_dataset, val_dataset, collate_fn=None):
        ...
        if collate_fn is None:
            from user.data.datasets import collate_fn
