...
class NodeProbe:
    ...
    def _configure_node_envs(self):
        ...
        2. Environment variables set between ray start and USER initialization on the head node (usually via bash scripts). These env vars are likely set by users intended to configure all nodes in the cluster.
        ...
        # First find env vars set between ray start and USER initialization on the head node
