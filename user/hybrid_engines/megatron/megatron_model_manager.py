...
from user.config import build_config, build_transformer_config
from user.data.tokenizers import hf_tokenizer
from user.utils.flops import FLOPSCalculator, ModelConfig
from user.utils.initialize import initialize_megatron, set_megatron_args
from user.utils.logging import get_logger
from user.utils.profiler import PyTorchProfiler, PyTorchProfilerFunc
...
class MegatronModelManager:
    ...
    def __init__(self, cfg: DictConfig):
        if not HAVE_MEGATRON_CORE:
            raise "Megatron-core was not found. Please see the USER README for installation instructions."
