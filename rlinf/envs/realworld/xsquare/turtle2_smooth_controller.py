...
from basics.turtle2_controller.Turtle2Controller import Turtle2Controller
...
class Turtle2SmoothController(Worker):
    ...
    def __init__(self, freq = 50):
        ...
        timer_period = rospy.Duration(1/freq)

        # FIXME: should move to roscontroller
        rospy.Timer(timer_period, self.smooth_action_callback)
        self.left_arm_target = [0, 0, 0, 0, 0, 0, 0]
        self.right_arm_target = [0, 0, 0, 0, 0, 0, 0]

        # xyz, rpy, gripper
        self.tol = [0.007, 0.02, 5] # m, rad, cm
        self.xyz_speed = 0.6  # m/s
        self.rpy_speed = 2.0  # rad/s
        self.freq = freq
    ...
    def smooth_action_callback(self, event):
        ...
        if errxyz1 < self.tol[0] and errxyz2 < self.tol[0] and errrpy1 < self.tol[1] and errrpy2 < self.tol[1]:
            ...
            # interpolate xyz
            dirxyz1 = (targetxyz1 - curxyz1) / errxyz1
            dirxyz2 = (targetxyz2 - curxyz2) / errxyz2
            ...
            # interpolate rpy
            dirrpy1 = (targetrpy1 - currpy1) / errrpy1
            dirrpy2 = (targetrpy2 - currpy2) / errrpy2
