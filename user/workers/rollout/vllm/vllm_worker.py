...
from user.config import torch_dtype_from_precision
from user.data.io_struct import RolloutRequest, RolloutResult, SeqGroupInfo
from user.scheduler import Channel, Worker
from user.scheduler.dynamic_scheduler.manager import RolloutScalingScheduler
from user.scheduler.dynamic_scheduler.utils import get_scheduler_channel
from user.utils.data_process import process_image_data
from user.utils.placement import ModelParallelComponentPlacement
from user.workers.rollout.utils import RunningStatusManager, print_vllm_outputs
...
class VLLMWorker(Worker):
    ...
    async def init_worker(self) -> None:
        ...
        vllm_worker_cls = "user.hybrid_engines.vllm.vllm_0_8_5.worker.VLLMWorker"
